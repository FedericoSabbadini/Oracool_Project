...
return [
    ...
    'FIFA Club World Cup' => ['Manchester City', 'Chelsea', 'Real Madrid', 'Bayern Munich', 'Paris Saint Germain', 'Inter Milan', 'Benfica', 'Al Ahly', 'Wydad Casablanca', 'Espérance de Tunis', 'Mamelodi Sundowns', 'Urawa Red Diamonds','Al Hilal', 'Al Ittihad', 'Auckland City', 'León', 'Monterrey', 'Seattle Sounders', 'Palmeiras', 'Flamengo','Fluminense', 'River Plate', 'Botafogo', 'Porto', 'Juventus', 'Borussia Dortmund', 'Red Bull Salzburg', 'Atlético Madrid', 'Inter Miami', 'Los Angeles FC', 'Boca Juniors', 'Al Ain', 'Ulsan Hyundai', 'CF Pachuca']
    ],
