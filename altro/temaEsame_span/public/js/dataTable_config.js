...
function initializeDataTable(tableId = 'dataTable', options = {}) {
    ...
    $(document).ready(function () {
        ...
        const defaultConfig = {
            ...
            dom: '<"row"<"col-6"f><"col-6 custom-pagination"p>>' +
                '<"row"<"col-12"tr>>',
...
// <script> initializeDataTable('myTableId', { order: [[1, 'desc']] }); </script>
// <script> initializeDataTable('myTableId', { language: { searchPlaceholder: "Cerca qui..." } }); </script>
// <script> initializeDataTable('myTableId', { responsive: false }); </script>
