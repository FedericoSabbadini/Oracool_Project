            ...
            <div class="container px-4">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link @yield('add-active')" href="{{ route('transactions.create') }}">Add</a></li>
                        <li class="nav-item"><a class="nav-link @yield('edit-active')"" disabled>Edit</a></li>
                    </ul>
                </div>
            </div>
        </nav>
